          ...
          <div className="px-[16px] pb-[16px]">
            <div className="flex items-center gap-[12px] pb-[12px]">
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(135deg, rgba(122,158,130,0.2) 0%, rgb(209,250,229) 100%)",
                }}
              >
                <img
                  src={roommateProfileIcon}
                  alt=""
              ...
              <div className="flex flex-col gap-[2px]">
                <div className="flex items-center gap-[8px]">
                  <span className="font-black text-[#111827] text-[14px] leading-[20px]">
                    {roommate.nickname}
                  </span>
            ...
            <div className="flex gap-[8px]">
              ...
              >
                ...
                <span className="font-semibold text-[#059669] text-[12px] leading-[16px]">
                  공유 캘린더
                </span>
              </button>
              <button
              ...
              >
                <span className="font-semibold text-[#f87171] text-[12px] leading-[16px]">
                  해지
                </span>
              </button>
            </div>
